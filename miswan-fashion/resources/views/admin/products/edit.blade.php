...
<div class="card border-0 shadow-sm rounded-lg p-4 bg-white">
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
        <h5 class="font-weight-bold text-dark m-0">Edit Product: {{ $product->name }}</h5>
            ...
            <div class="col-md-4">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="number" step="any" name="price" class="form-control" value="{{ old('price', $product->price) }}" required>
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label class="font-weight-bold small">Previous Price</label>
                        <input type="number" step="any" name="previous_price" class="form-control" value="{{ old('previous_price', $product->previous_price) }}">
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="colors" class="form-control" value="{{ old('colors', $product->colors) }}" placeholder="e.g. Red, White, Black">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="mb-2">
                        <img src="{{ asset($product->thumbnail) }}" width="80" class="rounded border">
                    </div>
                ...
                <div class="form-group mb-3">
                    <div class="custom-control custom-checkbox mb-2">
                        <input type="checkbox" class="custom-control-input" id="isFeatured" name="is_featured" value="1" {{ $product->is_featured ? 'checked' : '' }}>
                        <label class="custom-control-label" for="isFeatured">Featured Product</label>
                    </div>
                    <div class="custom-control custom-checkbox mb-2">
                        <input type="checkbox" class="custom-control-input" id="isBestseller" name="is_bestseller" value="1" {{ $product->is_bestseller ? 'checked' : '' }}>
