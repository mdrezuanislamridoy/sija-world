...
<head>
    ...
    <style type="text/css">
        @font-face {font-family:'Montserrat';font-style:normal;font-weight:100 900;src:url({{ asset('assets/cf-fonts/v/montserrat/5.2.8/latin/wght/normal.woff2') }});font-display:swap;}
    </style>

    <link rel="stylesheet" href="{{ asset('assets/vendor_assets/cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/assets/owl.carousel.min.css') }}">
    ...
    <link href="{{ asset('assets/ecommerce/dist/css/custom-css.css') }}" media="all" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/ecommerce/dist/css/responsive.css') }}" media="all" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/ecommerce/dist/css/premium-theme.css') }}" media="all" rel="stylesheet" type="text/css" />
...
<body dir="ltr">
    ...
    <div class="mobile-bottom-nav d-md-none">
        ...
        <a href="{{ route('category.show', 'fashion-women') }}">
            <i class="fa fa-th-large"></i>
            <span>Categories</span>
        </a>
        <a href="{{ route('cart.index') }}" class="position-relative {{ request()->is('cart*') ? 'active' : '' }}">
            <i class="fa fa-shopping-bag"></i>
            <span>Cart</span>
        </a>
        <a href="{{ route('track.order') }}" class="{{ request()->is('track-order*') ? 'active' : '' }}">
