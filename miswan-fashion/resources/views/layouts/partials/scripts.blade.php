...
<script src="{{ asset('assets/vendor_assets/cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.min.js') }}"></script>
<script src="{{ asset('assets/vendor_assets/cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js') }}"></script>
