        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                <div class="footer-widget">
                    ...
                    <ul class="list-unstyled" style="font-size: 14px; line-height: 2;">
                        <li><a href="{{ route('login') }}" class="text-muted">My Account</a></li>
                        <li><a href="{{ route('user.orders') }}" class="text-muted">Order History</a></li>
                        ...
                        <li><a href="{{ route('checkout.index') }}" class="text-muted">Checkout</a></li>
                    </ul>
                </div>
            </div>
