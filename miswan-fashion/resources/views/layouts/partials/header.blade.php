        ...
        <div class="container">
            ...
            <div class="mobile-header-row d-flex d-md-none align-items-center justify-content-between py-1">
                ...
                <a href="{{ url('/') }}" class="logo text-center d-inline-block">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="{{ $globalSetting->site_name ?? 'Sija World' }}" style="max-height: 48px; width: auto;">
                </a>
            ...
            <div class="row align-items-center d-none d-md-flex">
                ...
                <div class="col-md-3">
                    <a href="{{ url('/') }}" class="logo d-inline-block">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="{{ $globalSetting->site_name ?? 'Sija World' }}" style="max-height: 52px; width: auto;" class="site-logo">
                    </a>
                </div>
