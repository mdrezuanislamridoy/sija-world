                ...
                <div class="col-md-4 col-sm-12 text-md-right">
                    <div class="header-top-right text-white">
                        ...
                        <div class="auth-quick-links d-inline-block">
                            <a href="<?php echo e(route('track.order')); ?>" class="text-white font-weight-bold"><i class="fa fa-map-marker mr-1"></i> অর্ডার ট্র্যাক করুন (Track Order)</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <form class="form-inline w-100" method="GET" action="<?php echo e(route('products.search')); ?>">
                        <div class="search-categories w-100 position-relative">
                            <input type="text" autocomplete="off" name="q" placeholder="Search for premium fashion..." id="search" value="<?php echo e(request('q')); ?>" class="form-control w-100" style="border-radius: 25px; padding-left: 20px; border: 1px solid var(--border-color); box-shadow: inset 0 2px 4px rgba(0,0,0,0.02);">
    ...
    <div class="collapse" id="mainNavbarNav">
        <div class="bg-white border-top p-3 shadow-sm">
            <ul class="list-unstyled m-0">
                ...
                <li class="py-2"><a href="<?php echo e(route('track.order')); ?>" class="text-dark font-weight-bold"><i class="fa fa-map-marker mr-2 text-danger"></i> অর্ডার ট্র্যাক করুন (Track Order)</a></li>
            </ul>
        </div>
    </div>
</header>
<?php /**PATH /Volumes/2BT/Ridoy/fashion.picci/sija-world/miswan-fashion/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>