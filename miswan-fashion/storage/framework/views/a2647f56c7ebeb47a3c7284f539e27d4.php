...
<head>
    ...
    <title>Admin Portal Login - Miswan Fashion</title>
            ...
            <div class="col-md-5 col-lg-4">
                <div class="card border-0 shadow-lg rounded-lg p-4 bg-white">
                    <div class="text-center mb-4">
                        <h4 class="font-weight-bold text-dark mb-1"><i class="fa fa-lock text-primary"></i> Admin Portal</h4>
                        <p class="text-muted small">Miswan Fashion Management</p>
                    </div>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.login.post')); ?>">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="admin@miswanfashion.com" value="<?php echo e(old('email')); ?>" required autofocus>
                        </div>
...
<?php /**PATH /Volumes/2BT/Ridoy/miswan-fashion/resources/views/admin/login.blade.php ENDPATH**/ ?>