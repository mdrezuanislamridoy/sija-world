            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="footer-widget">
                    ...
                    <ul class="list-unstyled text-muted" style="font-size: 14px;">
                        ...
                        <li class="mb-2"><i class="fa fa-envelope text-primary mr-2"></i> <?php echo e($globalSetting->email ?? 'support@sijaworld.com'); ?></li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH /Volumes/2BT/Ridoy/fashion.picci/sija-world/miswan-fashion/resources/views/layouts/partials/footer.blade.php ENDPATH**/ ?>