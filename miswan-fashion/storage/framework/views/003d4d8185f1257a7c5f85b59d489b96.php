<?php $__env->startSection('title', 'Create an Account - ' . ($globalSetting->site_name ?? 'Miswan Fashion')); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('register.post')); ?>">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" name="phone" class="form-control" placeholder="017XXXXXXXX" value="<?php echo e(old('phone')); ?>" required pattern="^(?:\+?88)?01[3-9][0-9]{8}$">
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="name@example.com" value="<?php echo e(old('email')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="text-center border-top pt-3">
                            <p class="text-muted small m-0">Already have an account? <a href="<?php echo e(route('login')); ?>" class="font-weight-bold text-primary">Login Here</a></p>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\regin\Downloads\miswan-fashion\miswan-fashion\resources\views/auth/register.blade.php ENDPATH**/ ?>