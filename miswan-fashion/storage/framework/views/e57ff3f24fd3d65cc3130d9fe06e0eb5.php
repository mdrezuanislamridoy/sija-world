...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Control Panel'); ?> - Miswan Fashion</title>
    ...
    <aside class="admin-sidebar shadow">
        <div class="p-3 text-center border-bottom border-secondary mb-3">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-white text-decoration-none">
                <h5 class="font-weight-bold m-0"><i class="fa fa-shopping-bag text-primary"></i> MISWAN ADMIN</h5>
            </a>
        </div>
...
<?php /**PATH /Volumes/2BT/Ridoy/miswan-ashion/resources/views/admin/layout.blade.php ENDPATH**/ ?>