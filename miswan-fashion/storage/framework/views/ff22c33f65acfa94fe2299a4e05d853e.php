...
<body dir="ltr">
    ...
    <div class="mobile-bottom-nav d-md-none">
        ...
        <a href="<?php echo e(auth()->check() ? route('user.dashboard') : route('login')); ?>" class="<?php echo e(request()->is('login*') || request()->is('user*') ? 'active' : ''); ?>">
...
<?php /**PATH /Volumes/2BT/Ridoy/miswan-fashion/resources/views/layouts/app.blade.php ENDPATH**/ ?>