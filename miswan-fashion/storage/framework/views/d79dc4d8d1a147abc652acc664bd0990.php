        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="colors" class="form-control" value="<?php echo e(old('colors')); ?>" placeholder="e.g. Red, White, Black">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\regin\Downloads\miswan-fashion\miswan-fashion\resources\views/admin/products/create.blade.php ENDPATH**/ ?>